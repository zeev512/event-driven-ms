...
import il.co.migdal.ins.kafka.config.ElasticConfigData;
import il.co.migdal.ins.kafka.config.ElasticQueryConfigData;
import il.co.migdal.ins.elastic.model.index.impl.TwitterIndexModel;
import il.co.migdal.ins.elastic.query.client.service.impl.ElasticQueryClientException;
import il.co.migdal.ins.elastic.query.client.service.api.ElasticQueryClient;
import il.co.migdal.ins.elastic.query.client.util.ElasticQueryUtil;
